...
| 步骤 | 文件 |
|------|------|
| 1 | [初始请求](../../examples/INPUT.md) |
| 2 | [已批准规格](../../examples/SPEC.md) |
| 3 | [施工计划](../../examples/IMPLEMENTATION-PLAN.md) |
| 4 | [检查记录](../../examples/VERIFICATION.md) |
